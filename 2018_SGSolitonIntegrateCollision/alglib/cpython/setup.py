...
if sys.platform=="win32" or sys.platform=="cygwin":
    ...
    #
    libnames   = ["alglib314_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".dll"]
    targetname =  "alglib314_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".dll"
    dirname    = "bin-windows-intel"
else:
    libnames   = ["alglib314_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".so"]
    targetname = "alglib314_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".so"
