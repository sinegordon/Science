...
iters_count = int(sys.argv[2])
if len(sys.argv) == 4:
    gpuid = sys.argv[3]
sin30 = rad_mul*hex_rad*sin(pi/6)
sin60 = rad_mul*hex_rad*sin(pi/3)
hex_line = [[0, rad_mul*hex_rad], [-sin60, sin30], [-sin60, -sin30], [0, -rad_mul*hex_rad], [sin60, -sin30], [sin60, sin30], [0, rad_mul*hex_rad]]
...
hex_verts = coordsK
mc.shape_param.set('A', vertices=hex_verts)
hoomd.run(9000000)
