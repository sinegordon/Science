...
to Волгоградский государственный технический университет (Licensee, You).
...
void mlpgradbatchx(multilayerperceptron* network,
     ...
     ae_shared_pool* gradbuf,
     ae_state *_state);
void _spawn_mlpgradbatchx(multilayerperceptron* network,
    /* Real    */ ae_matrix* densexy,
    sparsematrix* sparsexy,
    ae_int_t datasetsize,
    ae_int_t datasettype,
    ...
    ae_int_t subsettype,
    ae_shared_pool* buf,
    ae_shared_pool* gradbuf, ae_task_group *_group, ae_bool smp_enabled, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _task_mlpgradbatchx(ae_task_data *_data, ae_state *_state);
#endif
...
void mlpallerrorsx(multilayerperceptron* network,
     ...
     modelerrors* rep,
     ae_state *_state);
void _spawn_mlpallerrorsx(multilayerperceptron* network,
    /* Real    */ ae_matrix* densexy,
    sparsematrix* sparsexy,
    ae_int_t datasetsize,
    ae_int_t datasettype,
    ...
    ae_int_t subsettype,
    ae_shared_pool* buf,
    modelerrors* rep, ae_task_group *_group, ae_bool smp_enabled, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _task_mlpallerrorsx(ae_task_data *_data, ae_state *_state);
#endif
...
void kmeansupdatedistances(/* Real    */ ae_matrix* xy,
     ...
     ae_state *_state);
void _spawn_kmeansupdatedistances(/* Real    */ ae_matrix* xy,
    ae_int_t idx0,
    ae_int_t idx1,
    ae_int_t nvars,
    /* Real    */ ae_matrix* ct,
    ...
    /* Integer */ ae_vector* xyc,
    /* Real    */ ae_vector* xydist2,
    ae_shared_pool* bufferpool, ae_task_group *_group, ae_bool smp_enabled, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _task_kmeansupdatedistances(ae_task_data *_data, ae_state *_state);
#endif
